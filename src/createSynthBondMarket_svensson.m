function [longPrices, allTreasuries] = createSynthBondMarket_svensson(histSvenssonParams)
% create synthetic bonds and bond prices for given yield curves
%
% Inputs:
%   histSvenssonParams      nDates x (1 + nParams) table of historic dates
%                           and Svensson yield curve parameters
%
% Outputs:
%   longPrices              table with historic bond prices and cash-flows
%   allTreasuries           nBondsx1 array of Treasury objects
